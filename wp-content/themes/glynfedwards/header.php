...
<?php
	...
	if(get_field('social_youtube', 'option') != "") {
		echo '<li><a href="'.get_field('social_youtube', 'option').'" target="_blank"><i class="fab fa-youtube fa-lg"></i></a></li>';
	}
	if(get_field('social_linkedin', 'option') != "") {
		echo '<li><a href="'.get_field('social_linkedin', 'option').'" target="_blank"><i class="fab fa-linkedin fa-lg"></i></a></li>';
	}
	if(get_field('social_email', 'option') != "") {
		echo '<li><a href="mailto:'.get_field('social_email', 'option').'"><i class="far fa-envelope fa-lg"></i></a></li>';
	}
?>
						</ul>
						<?php
